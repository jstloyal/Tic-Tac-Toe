...
describe('It switches players turn', () => {
  const playerOne = { name: 'Sam', symbol: 'X' };
  const playerTwo = { name: 'Tom', symbol: 'O' };

  test('It switches current user to player2 after player1 makes a succesful move', () => {
    board.updateBoardArray(playerOne, 0);
    const currentPlayer = switchCurrentPlayer(playerOne, playerTwo);
